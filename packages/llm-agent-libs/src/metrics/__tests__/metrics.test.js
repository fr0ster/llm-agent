...
import { makeCapturingMetrics, makeClassifier, makeDefaultDeps, } from '../../testing/index.js';
...
describe('Pipeline metrics instrumentation', () => {
    ...
    it('increments classifierIntentCount per subprompt', async () => {
        ...
        assert.equal(snap.classifierIntentCount.byAttributes.get('intent=action'), 1);

...
function makeProvider(opts) {
    return {
        ...
        getModels: opts.models !== undefined || opts.throwOnModels
            ? async () => {
                if (opts.throwOnModels)
                    throw new Error('models fetch failed');
                // biome-ignore lint/style/noNonNullAssertion: checked by condition above
                return opts.models;
            }
            : undefined,
        getEmbeddingModels: opts.embeddingModels !== undefined || opts.throwOnEmbeddingModels
            ? async () => {
...
describe('LlmAdapter.getModels()', () => {
    ...
    it('excludeEmbedding works with IModelInfo objects', async () => {
        const allModels = [{ id: 'gpt-4' }, { id: 'ada-002' }];
        const embeddingModels = [{ id: 'ada-002' }];
        const provider = makeProvider({
            models: allModels,
            embeddingModels,
        });
...
//# sourceMappingURL=llm-adapter-embedding-models.test.js.map
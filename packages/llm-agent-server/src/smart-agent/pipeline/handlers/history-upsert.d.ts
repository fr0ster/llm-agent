 ...
 */
import type { CallOptions, HistoryTurn, IHistoryMemory, IHistorySummarizer, IRag } from '@mcp-abap-adt/llm-agent';
...
export declare function summarizeAndStore(args: SummarizeAndStoreArgs): Promise<void>;

...
import { assertCollectionName, createTableSql, dropTableSql, quoteIdent, } from '../schema.js';
describe('hana schema', () => {
    ...
    it('rejects names longer than 63 chars', () => {
        assert.throws(() => assertCollectionName('a'.repeat(64)), (err) => err.code === 'INVALID_COLLECTION_NAME');
    });

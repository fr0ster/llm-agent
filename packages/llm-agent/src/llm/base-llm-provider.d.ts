...
export declare abstract class BaseLLMProvider<C extends LLMProviderConfig = LLMProviderConfig> implements LLMProvider {
    readonly config: C;
    constructor(config: C);
    abstract chat(messages: Message[], tools?: unknown[], options?: LLMCallOptions): Promise<LLMResponse>;
    abstract streamChat(messages: Message[], tools?: unknown[], options?: LLMCallOptions): AsyncIterable<LLMResponse>;
    /**

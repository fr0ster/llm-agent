...
import { buildCorrectionMetadata, deprecateMetadata, filterActive, validateCorrectionMetadata, } from '../corrections/metadata.js';
...
describe('filterActive', () => {
    ...
    it('hides deprecated and superseded by default', () => {
        ...
        assert.deepEqual(out.map((i) => i.meta.canonicalKey), ['a', 'd']);
    });

...
Optional peer dependency of `@mcp-abap-adt/llm-agent-server`. Install when your smart-server.yaml names `openai` as the LLM provider, or when constructing OpenAIProvider programmatically.
